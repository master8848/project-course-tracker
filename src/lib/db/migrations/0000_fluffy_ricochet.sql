...
--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "all_videos" ADD CONSTRAINT "all_videos_video_id_videos_id_fk" FOREIGN KEY ("video_id") REFERENCES "public"."videos"("id") ON DELETE cascade ON UPDATE no action;
EXCEPTION
